...
const Profile = () => {
  ...
  const [showlistings, setShowlistingsError] = useState(false);
      ...
      {userListings && userListings.length > 0 && (
        <div className="flex flex-col gap-4 ">
          ...
          {userListings.map((listing) => (
            <div
              key={listing._id}
              className="border rounded-lg p-3 flex justify-between items-center gap-4 shadow-lg"
            >
              ...
              <Link
                className="text-slate-700 font-semibold hover:text-green-700 truncate"
